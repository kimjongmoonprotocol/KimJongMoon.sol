...
/**
    ...
    KimJongMoon not only has limitless meme token possibilies (probably the most marketable
    ...
    - 5% fee per transaction auto distributed to holders

    
    KimJongMoon will start with 10 BNB in liquidity so no whales will be present.
    ...
    Discord : https://discord.com/invite/9WC6EaSusA
...
contract KimJongMoon is Context, IERC20, Ownable {
    ...
    string private _name = "KimJongMoon";
    string private _symbol = "KIMJ";
